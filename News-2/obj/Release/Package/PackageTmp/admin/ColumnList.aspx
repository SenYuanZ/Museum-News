<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ColumnList.aspx.cs" Inherits="News_2.admin.ColumnList" %>
    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
       <asp:Repeater ID="Repeater1" runat="server">
           <ItemTemplate>
          <tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" /><%# Eval("ID") %></td>
          <td><%# Eval("sort") %></td>
          <td width="10%"><img src="<%# Eval("Columnimgsrc") %>" alt="" width="70" height="50" /></td>
          <td><%# Eval("KeywordTitle") %></td>
          <td><font color="#00CC99"><%# Eval("EnglishTitle") %></font></td>
          <td><%# Eval("ColumnKeyword") %></td>
          <td><%# Eval("KeywordDes") %></td>
