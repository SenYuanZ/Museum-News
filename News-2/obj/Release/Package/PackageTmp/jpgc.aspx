<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jpgc.aspx.cs" Inherits="News_2.jpgc" %>
                    ...
                    <div class="right">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <ul class="img_ul">
                                    <li class="MI">
                                        <img src="admin/<%# Eval("newsimgsrc") %>" width="184" height="137" />
                                        <a href="#" class="img_a"><%# Eval("newsTitle") %></a>
                                    </li>
                                     <%--<li class="MI">
                                        <img src="upload/img11.jpg" width="184" height="137" />
                                        <a href="#" class="img_a">三国-青瓷执盾桶</a>
                                    </li>--%>
                                    <%--<li class="MI">
                                        <img src="upload/img11.jpg" width="184" height="137" />
                                        <a href="#" class="img_a">三国-青瓷执盾桶</a>
                        ...
                        <div class="page">
                            <img src="upload/page.png" width="406" height="23" />
                        </div>
                    </div>
                </div>
